...
class ArduinoROS():
    def __init__(self):
        ...
        # <lk> a single topic. See 'SensorState.msg' -> Header, name, value
        self.sensorStatePub = rospy.Publisher('~sensor_state', SensorState)
        
        # --> SEE srv Folder for request/response message type 
	...
	# Initialize the controlller
        # <lk> Arduino() object- Interface to Arduino hardware via Serial cmd 
...
#                    self.sensors[len(self.sensors)]['output_pin'] = params['output_pin']
    ...
    # Service callback functions #<lk> see arduino_driver.py
...
# --------------------- Controlling the robot base from the programmme --------------- #
